  ...
  Constraint.prototype = {
    ...
    _checkAsserts: function ( value, asserts, group ) {
      ...
      for ( var i = 0; i < asserts.length; i++ ) {
        ...
        //   return result;
        //
        // // Vast assets majority return Violation
        // if ( result instanceof Violation )
        //   failures.push( result );
      }
      return failures;
  ...
  */
  ...
  Violation.prototype = {
    ...
    __toString: function () {
      ...
      return this.assert.__class__ + ' assets failed for "' + this.value + this.violation || '';
    },
    ...
    */
    ...
    Length: function ( boundaries ) {
      ...
      if ( !boundaries.min && !boundaries.max )
        throw new Error( 'Lenth assets must be instanciated with a { min: x, max: y } object' );
    ...
    Range: function ( min, max ) {
      ...
      if ( 'undefined' === typeof min || 'undefined' === typeof max )
        throw new Error( 'Range assets expects min and max values' );
      this.min = min;
      this.max = max;
      this.validate = function ( value ) {
          try {
  ...
  */
  ...
  var ConstraintFactory = function (parsleyField, name, requirements, priority, isDomConstraint) {
    ...
    if ('function' === typeof assert.requirementsTransformer) {
      ...
      // rebuild assets with new requirements
      assert = window.ParsleyValidator.validators[name](requirements);
    }
